...
class UtilisateurResourceIT {
    ...
    void createUtilisateur() throws Exception {
        ...
        assertThat(testUtilisateur.getNomUtilisateur()).isEqualTo(DEFAULT_NOM_UTILISATEUR);
    ...
    void putNewUtilisateur() throws Exception {
        ...
        Utilisateur testUtilisateur = utilisateurList.get(utilisateurList.size() - 1);
        assertThat(testUtilisateur.getNomUtilisateur()).isEqualTo(UPDATED_NOM_UTILISATEUR);
    ...
    void partialUpdateUtilisateurWithPatch() throws Exception {
        ...
        partialUpdatedUtilisateur.nomUtilisateur(UPDATED_NOM_UTILISATEUR).dateInscription(UPDATED_DATE_INSCRIPTION);
