...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Operateur}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class OperateurResource {
    ...
    public ResponseEntity<Operateur> partialUpdateOperateur(
        ...
        Optional<Operateur> result = operateurRepository
            ...
            .map(existingOperateur -> {
                if (operateur.getCentreRc() != null) {
                    existingOperateur.setCentreRc(operateur.getCentreRc());
                }
                if (operateur.getNumeroRc() != null) {
                    existingOperateur.setNumeroRc(operateur.getNumeroRc());
                }
    ...
    public ResponseEntity<List<Operateur>> getAllOperateurs(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of Operateurs");
        Page<Operateur> page = operateurRepository.findAll(pageable);
