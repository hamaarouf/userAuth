...
export const createEntity = createAsyncThunk(
  ...
  async (entity: IUtilisateur, thunkAPI) => {
    return axios.post<IUtilisateur>(apiUrl, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError }
);
...
export const updateEntity = createAsyncThunk(
  ...
  async (entity: IUtilisateur, thunkAPI) => {
    return axios.put<IUtilisateur>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError }
);
...
export const partialUpdateEntity = createAsyncThunk(
  ...
  async (entity: IUtilisateur, thunkAPI) => {
    return axios.patch<IUtilisateur>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError }
);
...
export const deleteEntity = createAsyncThunk(
  ...
  async (id: string | number, thunkAPI) => {
    const requestUrl = `${apiUrl}/${id}`;
    return await axios.delete<IUtilisateur>(requestUrl);
  },
  { serializeError: serializeAxiosError }
);
