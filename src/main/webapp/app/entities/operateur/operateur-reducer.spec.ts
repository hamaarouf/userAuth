...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './operateur.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OPERATEUR_LIST actions', async () => {
    ...
    it('dispatches FETCH_OPERATEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OPERATEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OPERATEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OPERATEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OPERATEUR actions', async () => {
      const expectedActions = [
        {
